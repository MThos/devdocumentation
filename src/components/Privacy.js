  ...
  return (
    <div className="legal-flex fade-in">
      ...
      <div className="legal">
        ...
        <div className="legal-body">
          For more information about your privacy, if you have questions, or if you would like to make a complaint, please contact us by e-mail: <a href="mailto:mykel.thos@gmail.com">mykel.thos@gmail.com</a>
        </div>
      </div>
    </div>
  )
